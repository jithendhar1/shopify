			...
			<form action="./RegisterSrv" method="post"
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<!--  <input type="number" name="mobile" class="form-control" id="last_name" name="last_name" required> -->
						  <input required name="mobile" class="form-control" type="text" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
					</div>
					<div class="col-md-6 form-group">
